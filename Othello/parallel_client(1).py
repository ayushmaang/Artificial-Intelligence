...
from strategy4_2018aganotra import Othello_Core as core
from strategy4_2018aganotra import strategy as ai ## to access constants directly
...
ai2 = ai.Strategy()  ## make this different to play 2 different strategy files
...
def play(black_strategy, white_strategy, black_name, white_name, time_limit=60):
    ...
    while player is not None:
        ...
        p.terminate()
        time.sleep(0.01)
        #if p.is_alive(): os.kill(p.pid, signal.SIGILL)
...
if __name__ == "__main__":
    tournament_player(ai1.best_strategy, ai2.best_strategy, "black", "white", 1)
    ai1.saveFile()
